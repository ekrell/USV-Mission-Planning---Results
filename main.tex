...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.35\textwidth}  
        ...
        \caption{\small{3-A, terrain only}}
    ...
    \begin{subfigure}[b]{0.35\textwidth} 
        ...
        \caption{\small{3-B, terrain only}}
